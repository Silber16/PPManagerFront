...
export default function Tasks({projectTasks, projectId}) {
    ...
    async function handleCreateTask(task) {
        ...
        try {
            await axios.post(`${import.meta.env.VITE_BACK_URI}/api/Tasks/Create`, task)
            setTasks([...tasks, task])
    ...
    async function send(data) {
        ...
        try {
            await axios.patch(`${import.meta.env.VITE_BACK_URI}/api/Tasks/Edit/${editingTask.id}`, data) 
            setIsEditing(false)
            window.location.reload()
        } catch (e) {
    ...
    function deleteTask(taskId) {
        if (taskId != undefined) {
            axios.delete(`${import.meta.env.VITE_BACK_URI}/api/Tasks/Delete/${taskId}`)
              .then(response => {
