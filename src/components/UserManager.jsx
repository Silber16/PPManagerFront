...
export default function UserManager() {
    ...
    useEffect(() => {
      axios.get(`${import.meta.env.VITE_BACK_URI}/api/Account/GetUserInfo`, {withCredentials:true})
        .then(res => {
            if (res != null) {
    ...
    function LogOut() {
        axios.post(`${import.meta.env.VITE_BACK_URI}/api/Account/LogOut`, null, {withCredentials:true})
          .then(res => {
